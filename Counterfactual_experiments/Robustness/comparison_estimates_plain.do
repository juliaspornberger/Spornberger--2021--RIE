...
* Define variables for baseline and counterfactual scenario
	* First step		
	global indepI = "RTA RTA_lag3 RTA_lag6  BORDERx1998 BORDERx2001 BORDERx2004 BORDERx2007 BORDERx2010 BORDERx2013 "
	...
	* Second step (CONTROLS explaining endogeneity of RTA (EU): lDISTii lDISTij noCONTIG noCOLONY noCOMLANG)
	global indepII = "lDISTii lDISTij noCONTIG noCOLONY noCOMLANG BORDER "
...
********************** Weights following **************
********************************************************************************/
display as red "start step: Shares following Honorè and Kesina (2017) "	
...
program define bootprogram1, eclass
	...
	preserve	
		...
		*	mata st_store(., "t_CFL", (t_CFL))
			...
			* Rename columns 
			local colnames_II
			local colnames_II `colnames_II' "lDISTii lDISTij noCONTIG noCOLONY noCOMLANG BORDER  "
...
qui{
	...
	* Rename cols as variables
	matrix colnames coefs_I = RTA RTA_lag3 RTA_lag6  BORDERx1998 BORDERx2001 BORDERx2004 BORDERx2007 BORDERx2010 BORDERx2013 
	matrix colnames CI_I =RTA RTA_lag3 RTA_lag6  BORDERx1998 BORDERx2001 BORDERx2004 BORDERx2007 BORDERx2010 BORDERx2013 
	
	matrix colnames coefs_II = lDISTii lDISTij noCONTIG noCOLONY noCOMLANG BORDER 		
	matrix colnames CI_II = lDISTii lDISTij noCONTIG noCOLONY noCOMLANG BORDER 
* Check data
clear
mat li coefs_I
mat li coefs_II
...
display as red "done step: Weights following Honorè and Kesina (2017)"	
...
qui{
display as red "start step: Two-way"	
...
local varnames = "RTA RTA_lag3 RTA_lag6  BORDERx1998 BORDERx2001 BORDERx2004 BORDERx2007 BORDERx2010 BORDERx2013 "
forvalues i = 1/`=_N' {
...
local varnames = "lDISTii lDISTij noCONTIG noCOLONY noCOMLANG BORDER  "
forvalues i = 1/`=_N' {
    local varname : word `i' of `varnames'
    quietly replace varnames2 = "`varname'" in `i'
}
order varnames*
save "Estimates\Robustness\comparison_estimates_plain.dta", replace
